...
namespace HomeSurveillanceApp.Controllers
{
    public class DevicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("DeviceId,MACAddress,Name,Location")] Device device)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DeviceId,MACAddress,Name,Location")] Device device)
        {
