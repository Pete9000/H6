...
namespace HomeSurveillanceAPI.Migrations
{
    ...
    [Migration("20210202184901_dbinit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeSurveillanceAPI.Models.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HomeSurveillanceAPI.Models.UserGroup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("HomeSurveillanceAPI.Models.User", b =>
                {
                    b.HasOne("HomeSurveillanceAPI.Models.UserGroup", null)
                        .WithMany()
